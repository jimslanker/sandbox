...
--------------------------------------------------------------------------------
spool IMPL_STCR7639_1_output.txt
...
PROMPT >>---------------------------------------------------------------------<<
PROMPT >>
PROMPT >> Correct issue with missing Out of Spec Emails on Test Results
PROMPT >>
PROMPT >> Log file = IMPL_STCR7639_1_output.txt 
PROMPT >>
PROMPT >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
PROMPT >> Step #1                                                             >>         
...
PROMPT >> End of STCR7639_implement Script
select sysdate from dual;
