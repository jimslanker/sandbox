...
AS
   SELECT b.plant_no "SITE",
          ...
          (CASE b.plant_no
              ...
              THEN                                                              --STCR 7572 
                 SUBSTR (                                                       --STCR 7572 
                       TO_CHAR (b.key_size_entered)                             --STCR 7572 
                    || DECODE (UPPER (b.key_size_uom),                          --STCR 7572 
                               'IN', '"',                                       --STCR 7572 
                               b.key_size_uom)                                  --STCR 7572 
                    || ' '                                                      --STCR 7572 
                    || (SELECT melt_profile_desc                                --STCR 7572 
                          FROM te_melt_profiles                                 --STCR 7572 
                         WHERE melt_profile_ref = c.ingot_num_of_melts)         --STCR 7572 
                    || ' '                                                      --STCR 7572 
                    || f.shape_type_desc,                                       --STCR 7572 
                    1,                                                          --STCR 7572 
                    100)                                                        --STCR 7572                  
              ELSE
                 NULL
