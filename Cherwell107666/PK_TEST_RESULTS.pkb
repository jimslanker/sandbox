CREATE OR REPLACE PACKAGE BODY STAR.Pk_Test_Results IS
  ...
  /******************************************************************************
     ...
     5.23  13-DEC-2021 Jim Slanker        STCR 7639 Modify PR_SEND_RESULT_EMAIL_TYPES to include delete to Global Temp Table GTT_TE_TEST_RESULTS     
  */
  --
...
--STCR6169   DECODE (min_value_uom, NULL, max_value_uom, min_value_uom) uom -- Brought over from Pk_Mt_Materials.create_mt_results for SCTR 3551.
  ...
  */
  ...
  BEGIN
    ...
    DELETE FROM GTT_TE_TEST_RESULTS;                         --STCR 7639  Global Temp table changed to not delete on Commit
